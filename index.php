...
<div class="hero">
    <div class="hero-content">
        <?php if (!empty($ozgecmis["fotograf"])): ?>
            <img src="upload/ozgecmis/<?php echo $ozgecmis["fotograf"]; ?>" class="hero-foto" alt="Aday Fotoğrafı">
        <?php endif; ?>
        <div class="hero-text">
            <h2><?php echo htmlspecialchars($ayarlar["site_adi"]); ?></h2>
            <p>Sizin için çalışıyorum, birlikte daha güçlü bir gelecek inşa edelim.</p>
        </div>
    </div>
</div>

<main>
    <section class="soz-bolumu scroll-reveal">
        <p class="soz-metni">"<?php echo htmlspecialchars($ayarlar["soz_metni"]); ?>"</p>
        <p class="soz-sahibi"><?php echo htmlspecialchars($ayarlar["soz_sahibi"]); ?></p>
        <p class="soz-unvan"><?php echo htmlspecialchars($ayarlar["soz_unvan"]); ?></p>
    </section>
    ...
    <section>
        ...
        <div class="hizmet-grid">
            <?php foreach ($hizmetler as $hizmet): ?>
                <div class="hizmet-karti scroll-reveal">
    ...
    <section class="cta-bolumu scroll-reveal">
        <h2 style="border: none; color: white;">Bize Katılmak İster misiniz?</h2>
        <p>Birlikte daha güçlü bir gelecek için bugün adım atın.</p>
        <a href="iletisim.php" class="cta-buton">İletişime Geçin</a>
    </section>
</main>
